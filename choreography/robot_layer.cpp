...
google::protobuf::Timestamp _timeFromStart;
...
RobotCommandResponse SpotControl::velocityMoveTrajectory(double x, double y, double rot, gravAlignedFrame frame , bool relTime, google::protobuf::Timestamp endTime){
    RobotCommand command;
    SE2VelocityCommand_Request se2VelocityCommand_Request;
 ...
 std::shared_ptr<CoreLayer::SpotBase> SpotControl::returnSpotBase() {
     return _spotBase;
 }
...
/*
//Spot Social Behavior Team 
RobotCommandResponse SpotControl::ParamsAndMove(MobilityParams mParams, double x, double y, double rot, int64_t time, gravAlignedFrame frame){
    RobotCommand command;
    SE2VelocityCommand_Request se2VelocityCommand_Request;
