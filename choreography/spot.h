...
public:
    ...
    /* Spot Social Body Movement */
    RobotCmdRespData setBodyMotion(Trajectory3D trajectory, bool gravityAlign, double x, double y, double angular, int64_t time, gravAlignedFrame frame);
