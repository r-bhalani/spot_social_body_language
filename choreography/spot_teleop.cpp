...
int main(int argc, char *argv[]) {
	...
	while(keepRunning){
		...
		// set body pose based on rotations of roll/pitch/yaw
		...
		/*
			...
			posX, posY, posZ - center of mass, w.r.t. square of the feet
			roll, pitch, yaw - when stated with respect to FLAT_BODY are offsets from the plane parallel to the earth
			velX, velY - SE2 coordinates w.r.t. current position
			rot - SE2 rotation about axis perpendicular to the earth
			time - We've got no idea. We should look this up.
